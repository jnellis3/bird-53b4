...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bird-53b4)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bird-53b4
```

A live public deployment of this template is available at [https://bird-53b4.templates.workers.dev](https://bird-53b4.templates.workers.dev)
